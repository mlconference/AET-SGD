...
# list for all files
for fileName in glob.glob("eps2/*.json", recursive=True):
...
file_name = FIGURE_PATH + "iteration_" + expt_data_set + "_" + problemType + ".png"
print("fileName={}".format(file_name))
fig.savefig(file_name)

# pdf
file_name_pdf = PDF_PATH + "iteration_" + expt_data_set + "_" + problemType + ".pdf"
